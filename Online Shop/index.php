						...
						<div class="panel panel-primary">
							...
							<div class="panel-heading">
								...
								Password: <input type="password" name="pwd" value="123456"><br> -->
									...
									<input type="password" class="form-control"  name="pwd" id="password" value="">
									<p><br></p>
									<a href="#" style="color: white;list-style-type: none;">Forgot Password?</a>

									<!-- <input type="submit" name="userLogin"> -->
									<input type="submit" class="btn btn-success" style="float: right;bottom:12px;" id="login" value="Login" name="userLogin">
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="panel panel-info">
					...
					<!-- <div class="panel-footer">&copy; Kinan & Oru</div> -->
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
